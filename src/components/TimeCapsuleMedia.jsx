...
const closeUploadMediaDialog = ()=>{
 ...
 const closeViewMediaDialog = ()=>{
  ...
  return (
    ...
    <UploadMediaDialog open={openUploadMediaDialog}   setOpen={closeUploadMediaDialog} uploadMedia={uploadMedia} refreshData={refreshData} type={2} />
    <ViewMediaDialog open={openViewMediaDialog}   setOpen={closeViewMediaDialog}  refreshData={refreshData} type={2} />
