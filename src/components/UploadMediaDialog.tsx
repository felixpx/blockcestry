...
export default function UploadMediaDialog(props:any) {
  ...
  const uploadMedia = ()=>{
      ...
      props.uploadMedia(_name,_description,selectedFile,selectedMediaFile)
  }
  return (
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pt-5 pb-4 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                <div>
                 ...
                 <FontAwesomeIcon icon={faCloudArrowUp}   className={"text-4xl text-green-600"} />
                  </div>
  ...
  <div className="flex-1 mr-4">
   ...
   <div className="mt-2">
   <label htmlFor="fileInput" className="block text-base font-medium text-black mt-2 mb-2"  >NFT Image: </label>
  ...
  <div className="mt-2">
    ...
    <label htmlFor="fileInput" className="block text-base font-medium text-black mt-2 mb-2">File: </label>
      <input
        type="file"
        id="mediaFileInput"
