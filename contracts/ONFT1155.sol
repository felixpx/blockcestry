...
contract ONFT1155 is ONFT1155Core, ERC1155URIStorage, IONFT1155 {
    ...
    function mint(address _userAddress, uint tokenId, uint quantity) external payable {
    
        _mint(_userAddress, tokenId, quantity , '0x00');
